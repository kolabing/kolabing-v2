...
<div class="mt-12 rounded-[2rem] border border-off-black/10 bg-primary/25 p-8 md:flex md:items-center md:justify-between md:gap-10">
    <div>
        ...
        <h2 class="mt-3 font-montserrat text-2xl font-black uppercase leading-tight md:text-3xl">{{ $total }} active communities in {{ $city }}.</h2>
        <p class="mt-3 max-w-xl text-off-black/75">Each one runs real events and is looking for good places to host them. Kolabing matches the ones that fit your space, so you fill a quiet night with a crowd that already wants to be there.</p>
    </div>
