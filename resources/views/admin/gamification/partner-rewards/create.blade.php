@extends('admin.layout', ['title' => 'New partner reward'])

@section('page_title', 'New partner reward')
...
@section('admin_content')
    <div class="card card-primary card-outline">
        <form method="POST" action="{{ route('admin.gamification.partner-rewards.store') }}">
            @csrf
            <div class="card-body">
