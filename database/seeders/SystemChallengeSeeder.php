...
class SystemChallengeSeeder extends Seeder
{
    ...
    private function businessMissions(): array
    {
        ...
        return [
            ...
            $this->row($b, 'business-publish-first-kolab', 'Publish your first Kolab', 'Publish your first Kolab opportunity.', ChallengeCategory::Milestone, MissionTrigger::KolabPublished, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once, true),
