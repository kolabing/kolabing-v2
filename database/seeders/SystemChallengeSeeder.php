...
class SystemChallengeSeeder extends Seeder
{
    ...
    private function attendeeMissions(): array
    {
        ...
        return [
            $this->row($a, 'attendee-complete-profile', 'Complete your attendee profile', 'Fill in your attendee profile to get started.', ChallengeCategory::Onboarding, MissionTrigger::ProfileCompleted, 1, ChallengeDifficulty::Easy, 10, MissionRepeat::Once),
            $this->row($a, 'attendee-first-checkin', 'Check in to your first Kolab', 'Check in at your first Kolab event.', ChallengeCategory::Milestone, MissionTrigger::EventCheckin, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            $this->row($a, 'attendee-attend-3-events-monthly', 'Attend 3 events this month', 'Check in to 3 events within a single month.', ChallengeCategory::Attendance, MissionTrigger::EventCheckin, 3, ChallengeDifficulty::Medium, 30, MissionRepeat::Monthly),
            ...
            $this->row($a, 'attendee-first-review', 'Leave your first review', 'Post your first review after an event.', ChallengeCategory::Content, MissionTrigger::ReviewPosted, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            ...
            $this->row($a, 'attendee-join-2-communities', 'Join 2 different communities', 'Join 2 different communities on the platform.', ChallengeCategory::Social, MissionTrigger::CommunityJoined, 2, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
    ...
    private function businessMissions(): array
    {
        ...
        return [
            $this->row($b, 'business-complete-profile', 'Complete your business profile', 'Fill in your business profile to get started.', ChallengeCategory::Onboarding, MissionTrigger::BusinessProfileCompleted, 1, ChallengeDifficulty::Easy, 10, MissionRepeat::Once),
            $this->row($b, 'business-upload-profile-photo', 'Upload a business profile photo', 'Add a profile photo for your business.', ChallengeCategory::Onboarding, MissionTrigger::BusinessPhotoUploaded, 1, ChallengeDifficulty::Easy, 10, MissionRepeat::Once),
            $this->row($b, 'business-publish-first-kolab', 'Publish your first Kolab', 'Publish your first Kolab opportunity.', ChallengeCategory::Milestone, MissionTrigger::KolabPublished, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            $this->row($b, 'business-first-application-received', 'Receive your first community application', 'Receive your first application from a community.', ChallengeCategory::Milestone, MissionTrigger::ApplicationReceived, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            $this->row($b, 'business-first-application-accepted', 'Accept your first community application', 'Accept your first application from a community.', ChallengeCategory::Milestone, MissionTrigger::ApplicationAccepted, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            $this->row($b, 'business-first-kolab-completed', 'Complete your first Kolab', 'Complete your first collaboration end to end.', ChallengeCategory::Milestone, MissionTrigger::CollaborationComplete, 1, ChallengeDifficulty::Easy, 50, MissionRepeat::Once),
            ...
            $this->row($b, 'business-receive-5-reviews', 'Receive 5 reviews from a Kolab', 'Collect 5 reviews from a Kolab.', ChallengeCategory::Content, MissionTrigger::ReviewReceived, 5, ChallengeDifficulty::Medium, 30, MissionRepeat::Once),
    ...
    private function communityMissions(): array
    {
        ...
        return [
            $this->row($c, 'community-complete-profile', 'Complete your community profile', 'Fill in your community profile to get started.', ChallengeCategory::Onboarding, MissionTrigger::CommunityProfileCompleted, 1, ChallengeDifficulty::Easy, 10, MissionRepeat::Once),
            $this->row($c, 'community-upload-profile-photo', 'Upload community profile photo', 'Add a profile photo for your community.', ChallengeCategory::Onboarding, MissionTrigger::CommunityPhotoUploaded, 1, ChallengeDifficulty::Easy, 10, MissionRepeat::Once),
            $this->row($c, 'community-apply-first-kolab', 'Apply to your first Kolab', 'Submit your first application to a Kolab.', ChallengeCategory::Milestone, MissionTrigger::ApplicationSubmitted, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            $this->row($c, 'community-get-accepted-first-kolab', 'Get accepted to your first Kolab', 'Have your first Kolab application accepted.', ChallengeCategory::Milestone, MissionTrigger::ApplicationAccepted, 1, ChallengeDifficulty::Easy, 20, MissionRepeat::Once),
            $this->row($c, 'community-first-kolab-completed', 'Complete your first Kolab', 'Complete your first collaboration end to end.', ChallengeCategory::Milestone, MissionTrigger::CollaborationComplete, 1, ChallengeDifficulty::Easy, 50, MissionRepeat::Once),
            ...
            $this->row($c, 'community-refer-first-business', 'Refer your first business', 'Refer a business that joins the platform.', ChallengeCategory::Referral, MissionTrigger::BusinessReferred, 1, ChallengeDifficulty::Easy, 50, MissionRepeat::Once),
