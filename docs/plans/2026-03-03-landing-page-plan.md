...
**Goal:** Replace `resources/views/welcome.blade.php` with a pixel-perfect Blade version of the stitch design, with the hero `<img>` replaced by a `<video>` background element.

**Architecture:** Single Blade file using the CDN Tailwind setup from the stitch (no Vite pipeline needed). Video source points to `/assets/hero.mp4` — the MP4 file will be added by the user later. A `public/assets/` directory is created now so the path is ready.

**Tech Stack:** Laravel Blade, Tailwind CSS CDN, Google Fonts CDN, Material Symbols CDN

---

### Task 1: Create `public/assets/` directory
...
```bash
mkdir -p public/assets && touch public/assets/.gitkeep
```

**Step 2: Commit**

```bash
git add public/assets/.gitkeep
git commit -m "chore: add public/assets directory for hero video"
```

---

### Task 2: Replace `welcome.blade.php` with pixel-perfect landing page
...
{{-- Header --}}
<header class="fixed top-0 w-full z-50 bg-off-white/80 backdrop-blur-md text-off-black px-8 py-5 flex justify-between items-center border-b border-off-black/5">
...
<section class="hero-video-container">
    ...
    <div class="absolute inset-0 bg-gradient-to-b from-off-black/40 via-off-black/20 to-off-black/40 flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 class="font-montserrat font-[900] text-white uppercase text-4xl md:text-5xl lg:text-[64px] mb-8 max-w-7xl leading-[1.1] tracking-tight">
            Kolabing makes the <span class="text-primary italic">MATCH!</span>
        </h1>
        <p class="text-xl md:text-2xl font-medium mb-12 text-white/95 max-w-3xl leading-relaxed">
        ...
        <div class="flex flex-col md:flex-row gap-5 mb-6">
            <a class="bg-off-black text-white px-8 py-4 rounded-2xl flex items-center gap-3 hover:bg-black transition-all shadow-xl group" href="#">
            ...
            <a class="bg-white text-off-black px-8 py-4 rounded-2xl flex items-center gap-3 hover:bg-gray-50 transition-all shadow-xl group" href="#">
...
{{-- How It Works --}}
<section class="py-32 bg-off-white relative overflow-hidden" id="how-it-works">
    <div class="absolute inset-0 dot-pattern opacity-[0.03]"></div>
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="text-center mb-32">
            <h2 class="text-4xl md:text-5xl font-montserrat font-black uppercase mb-4 tracking-tight">HOW TO GET A <span class="text-primary italic">KOLAB</span></h2>
            <p class="text-off-black/60 text-xl font-medium">Post. Match. Connect. Make it happen.</p>
        </div>
        <div class="relative pb-40">
            <svg class="hidden md:block absolute top-8 left-0 w-full h-[400px] z-0 pointer-events-none" preserveAspectRatio="none" viewBox="0 0 1200 400">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-6 relative z-10">
                <div class="step-1 flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <div class="bg-white p-8 rounded-3xl border-2 border-primary shadow-sm w-full transition-transform hover:-translate-y-2 duration-300">
                        <h4 class="font-bold text-xl mb-4 leading-tight flex flex-col md:flex-row items-center md:items-start gap-2">
                ...
                <div class="step-2 flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <div class="step-3 flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <div class="step-4 flex flex-col items-center md:items-start text-center md:text-left">
...
<section class="py-32 bg-primary relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <h2 class="text-4xl md:text-5xl font-montserrat font-black uppercase text-off-black mb-16"><span class="text-white italic">REAL</span> OUTCOMES</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white/50 backdrop-blur-sm p-12 rounded-4xl border border-white/30 shadow-sm">
...
<section class="py-40 px-6 bg-white">
    <div class="max-w-6xl mx-auto text-center">
        <h2 class="text-4xl md:text-5xl font-montserrat font-black uppercase mb-20 text-off-black leading-tight">
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-off-white">
                        <th class="p-10 text-left text-xs uppercase tracking-[0.2em] text-off-black/40 font-bold">WHY IT WORKS</th>
                        <th class="p-10 text-center bg-primary/10">
                        ...
                        <th class="p-10 text-center text-xs uppercase tracking-[0.2em] text-off-black/40 font-bold">Influencers</th>
                        <th class="p-10 text-center text-xs uppercase tracking-[0.2em] text-off-black/40 font-bold">Paid Ads</th>
                    </tr>
                </thead>
                <tbody class="font-medium text-lg">
                    <tr class="border-t border-off-black/5">
                        <td class="p-10 text-left text-off-black/60">Real connection</td>
                        <td class="p-10 text-center bg-primary/5 font-bold">Real people in your place</td>
                        <td class="p-10 text-center text-off-black/40">Online shoutout</td>
                        <td class="p-10 text-center text-off-black/40">Scroll + ignore</td>
                    </tr>
                    <tr class="border-t border-off-black/5">
                        <td class="p-10 text-left text-off-black/60">Trust</td>
                        <td class="p-10 text-center bg-primary/5 font-bold">Community presence</td>
                        <td class="p-10 text-center text-off-black/40">People are tired of influencers — low trust</td>
                        <td class="p-10 text-center text-off-black/40">Low trust</td>
                    </tr>
                    <tr class="border-t border-off-black/5">
                        <td class="p-10 text-left text-off-black/60">Results over time</td>
                        <td class="p-10 text-center bg-primary/5 font-bold">Repeat customers</td>
                        <td class="p-10 text-center text-off-black/40">One-time spike</td>
                        <td class="p-10 text-center text-off-black/40">Stops when you stop paying</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
{{-- Built For Both --}}
<section class="py-32 bg-off-black text-white" id="built-for-both">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div class="bg-white/5 p-12 rounded-5xl border border-white/5">
                <h3 class="text-3xl font-bold mb-10 text-primary">For Businesses</h3>
            ...
            <div class="bg-white/5 p-12 rounded-5xl border border-white/5">
                <h3 class="text-3xl font-bold mb-10 text-white">For Communities</h3>
                <ul class="space-y-8 mb-14">
                    <li class="flex gap-5">
                        <span class="material-symbols-outlined text-primary">check_circle</span>
...
{{-- Footer --}}
<footer class="bg-off-black text-white py-24">
    <div class="max-w-7xl mx-auto px-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-16 mb-20">
        ...
        <div class="pt-16 border-t border-white/10 text-center text-white/30 text-xs font-medium tracking-wide">
...
The `GET /` route already renders `welcome` view (Laravel default). No route change needed.

**Step 3: Commit**

```bash
git add resources/views/welcome.blade.php
git commit -m "feat: implement landing page with video hero"
```

---

### Notes for when the MP4 arrives

When the user provides the video file:
1. Place it at `public/assets/hero.mp4`
2. Optionally export a poster frame as `public/assets/hero-poster.jpg`
3. The `<video>` tag already points to both paths — no code change needed
