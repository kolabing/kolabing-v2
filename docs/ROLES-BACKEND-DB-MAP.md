...
## 18. Two-sided suggestions — backend map (BE-NF-39, added 2026-08-22)
...
> **Naming.** The backlog item is **BE-NF-39**. The code, routes, views and console comments still say
> **BE-NF-28** throughout: the work was numbered against a three-day-old BACKLOG and every id it used
> had been claimed by a parallel session (renumbered at commit `884543a`). The comments are stale, not
> wrong about anything else — when you touch one, fix the id.

### 18.1 The table — `kolab_suggestions`
...
### 18.2 The engine — `app/Services/Suggestions/`
...
### 18.3 Shared matching support — `app/Support/Matching/`
...
### 18.4 Endpoints, policy and the flag middleware
...
### 18.6 Where the blur is enforced, and where the funnel is written
...
### 18.7 Config — `config/suggestions.php`
...
### 18.8 Telemetry — `SuggestionTelemetry`
...
### 18.9 Not shipped (do not document it as shipped)
