...
class DashboardTest extends TestCase
{
    ...
    */
    ...
    public function test_business_dashboard_returns_received_application_stats(): void
    {
        ...
        Application::factory()->count(3)->forKolab($opportunity)->pending()->create();
        Application::factory()->count(2)->forKolab($opportunity)->accepted()->create();
        Application::factory()->forKolab($opportunity)->declined()->create();
    ...
    public function test_business_dashboard_returns_collaboration_stats(): void
    {
        ...
        $application1 = Application::factory()->forKolab($opportunity)->forApplicant($community)->accepted()->create();
        $application2 = Application::factory()->forKolab($opportunity)->accepted()->create();
        $application3 = Application::factory()->forKolab($opportunity)->accepted()->create();
        $application4 = Application::factory()->forKolab($opportunity)->accepted()->create();
    ...
    public function test_business_dashboard_returns_upcoming_collaborations(): void
    {
        ...
        $community = Profile::factory()->community()->create();
        $opportunity = Kolab::factory()->published()->forCreator($business)->create();
        $application = Application::factory()->forKolab($opportunity)->forApplicant($community)->accepted()->create();
    ...
    public function test_business_dashboard_does_not_include_past_collaborations_in_upcoming(): void
    {
        $business = Profile::factory()->business()->create();
        $opportunity = Kolab::factory()->published()->forCreator($business)->create();
        $application = Application::factory()->forKolab($opportunity)->accepted()->create();
    ...
    public function test_business_dashboard_does_not_include_other_users_data(): void
    {
        ...
        Kolab::factory()->published()->forCreator($otherBusiness)->create();
    ...
    */
    ...
    public function test_community_dashboard_returns_sent_application_stats(): void
    {
        ...
        $opportunities = Kolab::factory()->published()->forCreator($business)->count(5)->create();

        // Create applications in various statuses
        Application::factory()->forKolab($opportunities[0])->forApplicant($community)->pending()->create();
        Application::factory()->forKolab($opportunities[1])->forApplicant($community)->pending()->create();
        Application::factory()->forKolab($opportunities[2])->forApplicant($community)->accepted()->create();
        Application::factory()->forKolab($opportunities[3])->forApplicant($community)->declined()->create();
        Application::factory()->forKolab($opportunities[4])->forApplicant($community)->withdrawn()->create();
    ...
    public function test_community_dashboard_returns_collaboration_stats(): void
    {
        ...
        $application1 = Application::factory()->forKolab($opportunity1)->forApplicant($community)->accepted()->create();
        $application2 = Application::factory()->forKolab($opportunity2)->forApplicant($community)->accepted()->create();

        // Scheduled upcoming
        Collaboration::factory()
            ->forCreator($business)
            ->forApplicant($community)
            ->forKolab($opportunity1)
            ->forApplication($application1)
            ->scheduled()
