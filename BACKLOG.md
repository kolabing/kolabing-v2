...
>
> Last updated: 2026-08-15 (BE-NF-17 Stripe web checkout built, branch feat/stripe-web-checkout: implements source=stripe — POST /me/subscription/checkout + public /webhooks/stripe, business-only, return-URL allowlist, server-side price ids, referral-on-first-paid; no migration. Prior same day: BE-NF-16 blog engine + SEO/GEO built, branch feat/blog-engine-seo-geo: public /blog + admin /admin/blog CRUD + Article/Organization/WebSite/FAQPage JSON-LD + homepage meta/OG + sitemap/llms now include posts. Prior 2026-08-02: BE-FX-11 F1 host_profile_id on EventResource + BE-FX-8 chat
