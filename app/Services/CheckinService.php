...
class CheckinService
{
     ...
     *
     * Extracted because there are now THREE doors into the same room and they
     * must agree on what happens once someone is through one. In {@see checkin()}
     * the attendee scans a code the host is displaying; in
     * {@see TicketService::admit()} the host scans a code the attendee is
     * carrying; in {@see selfCheckin()} the attendee picks an event they already
     * said they were going to. Different proof, different party authenticated —
